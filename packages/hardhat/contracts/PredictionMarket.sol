...
contract PredictionMarket is Ownable {
    ...
    constructor(
        ...
        if (_percentageToLock > 0) {
            uint256 initialYesAmount = (initialTokenAmount * _initialYesProbability * _percentageToLock) / 10000;
            uint256 initialNoAmount = (initialTokenAmount * (100 - _initialYesProbability) * _percentageToLock) / 10000;
        ...
        )
    {
        ...
        optionToken1 = address(i_YesToken);
        optionToken2 = address(i_NoToken);
